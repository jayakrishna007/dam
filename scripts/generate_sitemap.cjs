...
function main() {
  ...
  const COUNTRY_ZONES = {
    ...
    'Brazil': ['Amazon', 'São Francisco', 'Paraná'],
    'Japan': ['Chubu', 'Kanto', 'Tohoku', 'Shikoku'],
    'Spain': ['Guadiana Basin', 'Tagus Basin', 'Duero Basin', 'Ebro Basin', 'Guadalquivir Basin'],
    'Australia': ['Murray-Darling Basin', 'East Coast Basin', 'North Coast Basin', 'Southern Basin'],
    'Mexico': ['Grijalva-Usumacinta Basin', 'Balsas Basin', 'Santiago Basin', 'Rio Bravo Basin'],
